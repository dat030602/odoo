...
class rp_detail_book_pdf(models.AbstractModel):
    _name = 'report.biz_details_of_account_books_ccv.rp_detail_book_pdf_ccv'
    _description = 'rp_detail_book_pdf_ccv'
    
    @api.model
    def _get_report_values(self, docids, data=None):
        doc = self.env['detail.book.account.ccv'].browse(docids)
        options = data
        ...
        return {
            ...
            'lines': res,
            'doc_model': 'detail.book.account.ccv',
        }