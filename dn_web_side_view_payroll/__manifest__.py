{
    ...
    'summary': "Inherit hr_payroll views with advanced side view support",
    'description': """
    Adds advanced viewing modes to the default Odoo 19 List View for payroll views.
    ...
    'version': '19.0.1.0.1',
    'license': 'LGPL-3',
    'depends': ['dn_web_side_view', 'hr_payroll'],
    'data': [],
    'assets': {
        'web.assets_backend': [
