...
{
    'name': "Bizapps - Manual Currency Exchange rate for Sales Order/Customer Invoice/Vendor Bills/Purchase Orders/Payments",
    'version': "16.0.0.1",
    ...
    "application": False,
    "installable": True,
    'depends': ['base', 'sale_management', 'purchase', 'stock', 'account','account_reports','biz_custom_invoice'],
    'data': [
