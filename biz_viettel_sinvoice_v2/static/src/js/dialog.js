odoo.define("biz_viettel_sinvoice_v2.PreviewDialog", function (require) {
"use strict";
...
var pdfPreview = core.Class.extend({
    ...
    preview: function( url ) {
        ...
        var urlTempalte = _.template("/biz_viettel_sinvoice_v2/static/lib/PDFjs/web/viewer.html?file=<%= url %>");
...
//        this.$modal.on("hidden.bs.modal", _.bind(this.destroy, this));
        this.$modal.find(".close").on("click", _.bind(this.destroy, this));
