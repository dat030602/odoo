...
class kpi_period(models.Model):
    ...
    def name_get(self):
        ...
        for period in self:
            date_start = period.date_start.strftime(lang_date_format) if period.date_start else ''
            date_end = period.date_end.strftime(lang_date_format) if period.date_end else ''
    ...
    def action_return_periods(self):
        ...
        return {
            ...
            "kpi_adming_rights": self.env.user.has_group("biz_kpi_scorecard.group_kpi_admin"),
        }
