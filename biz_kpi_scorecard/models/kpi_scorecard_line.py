...
class kpi_scorecard_line(models.Model):
    ...
    def _compute_formatted_actual_value(self):
        ...
        for line in self:
            ...
            if line.computation_error:
                ...
                line.result = "error"
                line.formatted_target_value = kpi_id and kpi_id._return_formated_appearance(
                    line.target_value, novalue_change=True, currency=company_currency,
                )
            else:
                actual_value = line.actual_value
                line.formatted_actual_value = kpi_id and kpi_id._return_formated_appearance(
    ...
    def _compute_edit_rights(self):
        ...
        admin_rights = active_user.has_group("biz_kpi_scorecard.group_kpi_admin")
        for line in self:
    ...
    target_value = fields.Float(string="Target Value", digits=(16,3))
    ...
    actual_value = fields.Float(string="Actual Value", digits=(16,3))
    ...
    @api.depends('kpi_id','kpi_id.employee_id')
    def _compute_employee_id(self):
        for res in self:
            res.employee_id = res.kpi_id.employee_id if res.kpi_id and res.kpi_id.employee_id else False
