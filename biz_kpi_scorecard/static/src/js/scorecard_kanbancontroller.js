...
const ScoreCardKanbanController = KanbanController.extend({
    ...
    jsLibs: [
        ...
        '/biz_kpi_scorecard/static/lib/jstree/jstree.js',
        '/web/static/lib/Chart/Chart.js',
    ],
    cssLibs: [
        '/biz_kpi_scorecard/static/lib/jstree/themes/default/style.css',
    ],
    init: function () {
    ...
    */
    _onReplaceTargets: function(event) {
        ...
        if (!self._isPeriodNotSet() && self.kpiAdmin && self.KPIPeriodState == "open") {             
            self.do_action("biz_kpi_scorecard.kpi_copy_template_action", {
