...
`;
    ...
    ChartFigure.template = TEMPLATE;
    ChartFigure.style = CSS;
...
`;
    ...
    TextFigure.template = TEMPLATE$1;
    TextFigure.style = CSS$1;
...
`;
    ...
    ColorPicker.template = xml$4 /* xml */ `
  ...
  `;
    ...
    const PREVIEW_TEMPLATE = xml$5 /* xml */ `
...
`;
    ...
    CellIsRuleEditor.template = TEMPLATE$4;
    CellIsRuleEditor.style = CSS$3;
    ...
    const PREVIEW_TEMPLATE$1 = xml$6 /* xml */ `
...
`;
    const THRESHOLD_TEMPLATE = xml$6 /* xml */ `
...
`;
    ...
    ColorScaleRuleEditor.template = TEMPLATE$5;
    ColorScaleRuleEditor.style = CSS$4;
    ...
    const PREVIEW_TEMPLATE$2 = xml$7 /* xml */ `
<div class="o-cf-preview">
  ...
  .o-cf {
    ...
    ConditionalFormattingPanel.template = TEMPLATE$6;
    ConditionalFormattingPanel.style = CSS$5;
    ...
    function compile(str, sheet, sheets) {
        ...
        function compileFunctionArgs(ast) {
            ...
            if (result.length < minArg || result.length > maxArg) {
                throw new Error(_lt("Invalid number of arguments for the %s function. Expected %s, but got %s instead.", ast.value.toUpperCase(), fn.args.length.toString(), result.length.toString()));
            }
            return result;
        }
...
`;
    ...
    TooltipComponent.template = xml$a /* xml */ `
    <div t-esc="props.content"/>
  `;

    const { Component: Component$8, useState: useState$6 } = owl__namespace;
...
`;
    ...
    const { useRef: useRef$2, useState: useState$7 } = owl.hooks;
...
`;
    class Composer extends Component$9 {
        constructor() {
            ...
            this.autoCompleteState = useState$7({
                showProvider: false,
                provider: "functions",
                search: "",
            });
    ...
    const TEMPLATE$c = xml$d /* xml */ `<div>
...
`;
    ...
    // Resizer component
    // -----------------------------------------------------------------------------
    class AbstractResizer extends Component$a {
        constructor() {
            super(...arguments);
            this.PADDING = 0;
...
`;
    ...
    exports.__info__.date = '2021-05-04T15:08:50.841Z';
    exports.__info__.hash = '89be95a';
