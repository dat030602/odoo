{
    'name': "LSF Inherit - sign",
    'summary': "Inherit sign views with advanced side view support",
    'description': """
    Adds advanced viewing modes to the default Odoo 19 List View for sign views.
    ...
    'assets': {
        'web.assets_backend': [
            'dn_web_side_view_sig/static/src/*.xml',
        ],
    },
