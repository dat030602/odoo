...
registerModel({
    name: 'MessageForwardCategoryItem',
    recordMethods: {
        /**
         * @param {MouseEvent} ev
         */
    ...
    fields: {
        ...
        channel: one('Channel', {
            identifying: true,
            inverse: 'messageForwardCategoryItem',
        }),
        // channel: one('Channel', {
        //     compute() {
        //         if (this.messaging.discuss.thread.channel) {
        //             return this.messaging.discuss.thread.channel;
        //         }
        //         return clear();
        //     },
        //     identifying: true,
