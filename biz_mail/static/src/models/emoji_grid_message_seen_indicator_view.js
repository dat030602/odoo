...
registerModel({
    name: 'EmojiGridMessageSeenIndicatorView',
    recordMethods: {
    ...
    fields: {
        ...
        emojiPickerMessageSeenIndicatorViewOwner: one('EmojiPickerMessageSeenIndicatorView', {
            identifying: true,
            inverse: 'EmojiGridMessageSeenIndicatorView',
        }),
