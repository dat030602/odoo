...
registerModel({
    name: 'EmojiPickerMessageSeenIndicatorView',
    lifecycleHooks: {
        _created() {
    ...
    fields: {
        ...
        //     },
        // }),
        EmojiGridMessageSeenIndicatorView: one('EmojiGridMessageSeenIndicatorView', {
            default: {},
            inverse: 'emojiPickerMessageSeenIndicatorViewOwner',
            readonly: true,
            required: true,
        }),
        ...
        popoverViewOwner: one('PopoverView', {
            identifying: true,
            inverse: 'emojiPickerMessageSeenIndicatorView',
        }),
        component: attr(),
    },
});
