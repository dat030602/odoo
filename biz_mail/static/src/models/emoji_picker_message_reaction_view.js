...
registerModel({
    name: 'EmojiPickerMessageReactionView',
    lifecycleHooks: {
        _created() {
    ...
    fields: {
        ...
        //     },
        // }),
        EmojiGridMessageReactionView: one('EmojiGridMessageReactionView', {
            default: {},
            inverse: 'emojiPickerMessageReactionViewOwner',
            readonly: true,
            required: true,
        }),
        ...
        popoverViewOwner: one('PopoverView', {
            identifying: true,
            inverse: 'emojiPickerMessageReactionView',
        }),
        component: attr(),
    },
});
