...
class Py3oReport(models.TransientModel):
    ...
    def _get_parser_context(self, model_instance, data):
        ...
        context.update(report_xml._get_rendering_context(report_xml, model_instance.ids, data))
    ...
    def _convert_single_report_cmd(
        ...
        if user_installation:
            import pathlib
            cmd.append("-env:UserInstallation=%s" % pathlib.Path(user_installation).as_uri())
        return cmd
