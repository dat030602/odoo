...
class AlphaReportLine(models.TransientModel):
    _name = 'alpha.report.line'
    _description = 'Tổng hợp công nợ'
    ...
    inventory_quantity = fields.Float("Số lượng kiểm kê", digits=(16, 3))
    diff_quantity = fields.Float("Chênh lệch", digits=(16, 3))
