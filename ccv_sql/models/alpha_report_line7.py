...
class AlphaReportLine7(models.TransientModel):
    _name = 'alpha.report.line7'
    _description = 'Danh sách chi tiết vốn tự có'
    ...
    amount = fields.Float(string="Số tiền", digits=(16, 0))
