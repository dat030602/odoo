...
class UserAttendance(models.Model):
    ...
    status = fields.Integer(string='Device Attendance State', required=False,
    ...
    attendance_state_id = fields.Many2one('attendance.state', string='Odoo Attendance State',
                                          ...
                                          ' status stored in the device and the attendance status in Odoo', required=False, index=True)
