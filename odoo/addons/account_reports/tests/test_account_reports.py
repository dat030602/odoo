...
class TestAccountReports(TestAccountReportsCommon):
    ...
    def test_tax_report_with_entries_on_sale_and_purchase_journals (self):
        ...
        report_lines_dict = {
            'sale': [
                self._create_tax_report_line('Sale base', test_country, sequence=1, tag_name='sale_b'),
                self._create_tax_report_line('Sale tax', test_country, sequence=1, tag_name='sale_t'),
            ],
            'purchase': [
                self._create_tax_report_line('Purchase base', test_country, sequence=2, tag_name='purchase_b'),
                self._create_tax_report_line('Purchase tax', test_country, sequence=2, tag_name='purchase_t'),
            ],
        }
