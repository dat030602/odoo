...
ERROR_MESSAGES = {
    ...
    ERROR_INVALID_ACCOUNT_TOKEN: _("The 'invoice_ocr' IAP account token is invalid. Please delete it to let Odoo generate a new one or fill it with a valid token."),
...
class AccountMove(models.Model):
    ...
    def get_form_context_manager(self):
        if 'default_journal_id' in self._context:
            ...
            self_ctx = self.with_context(force_company=self.company_id.id)
