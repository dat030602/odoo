...
from odoo.addons.account_reports.tests.common import _init_options, assertLinesValues
from odoo import fields
from odoo.tests import tagged


@tagged('post_install', '-at_install')
class TestClEightColumnsReport(AccountTestInvoicingCommon):
    ...
    def test_whole_report(self):
        ...
        options = _init_options(report, fields.Date.from_string('2017-01-01'), fields.Date.from_string('2017-12-31'))
        ...
        assertLinesValues(
            ...
            [
                ...
                ('Resultado del Ejercicio',             '',             '',     '',     '',         '',     1000.0, 1000.0, 0.0),
