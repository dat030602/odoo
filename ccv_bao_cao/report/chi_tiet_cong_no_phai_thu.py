...
COLUMNS = [
    ...
    {"size": 8,                                 "name": 'Số hóa đơn'         , 'field':"reference"                        , "type": 'text'               , "sum": False  },
    ...
    {"size": 7,                                 "name": 'ĐVT'                , 'field':"uom_id"                           , "type": 'text'               , "sum": False  },
    ...
    {"size": 10,  "group": "Phát sinh",         "name": 'Nợ'                 , 'field':"ps_debit"                     , "type": 'number_int'         , "sum": True  },
    {"size": 10,  "group": "Phát sinh",         "name": 'Có'                 , 'field':"ps_credit"                    , "type": 'number_int'         , "sum": True  },
    ...
    {"size": 10,                                "name": 'Mã hàng'            , 'field':"default_code"                     , "type": 'text'               , "sum": False  },
    {"size": 10,                                "name": 'Mã đơn hàng'        , 'field':"order_id"                         , "type": 'text'               , "sum": False  },
]
...
class chi_tiet_cong_no_phai_thu(models.AbstractModel):
    _name = "report.ccv_bao_cao.chi_tiet_cong_no_phai_thu"
            ...
            if line_ids:
                ...
                for data in line_ids:
                    ...
                    vals = {
                        ...
                        "product_uom_qty":    safe_data(data, "product_uom_qty"),
                        "price_unit":         safe_data(data, "price_unit"),
                        "ps_debit":           safe_data(data, "debit", is_num=True),
                        "ps_credit":          safe_data(data, "credit", is_num=True),
                        ...
                        "order_id":           safe_data(data, "order_id", sub_key="name"),
                    }
                    lines.append(vals)
    ...
    def add_title(self, sheet, formats, obj):
        ...
        sheet.merge_range("C2:O2","Công ty TNHH Con Cò Vàng - Mã số thuế: 0305995751",formats["company_name"],)
