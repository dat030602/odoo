...
TITLE = 'Tổng hợp công nợ phải trả USD'

COLUMNS = [
    {"size":  5,                                "name": 'STT'                , 'field':"no"                               , "type": 'number_c_int'       , "sum": False  },
    {"size": 12,                                "name": 'Mã nhà cung cấp'    , 'field':"customer_code"                    , "type": 'text'               , "sum": False  },
    {"size": 25,                                "name": 'Tên nhà cung cấp'  , 'field':"customer_name"                    , "type": 'text'               , "sum": False  },
    ...
    {"size": 10,  "group": "Dư Nợ đầu kỳ",    "name": 'Số tiền'           , 'field':"start_debit_usd"              , "type": 'number_float2'      , "sum": True  },
    {"size": 10,  "group": "Dư Nợ đầu kỳ",    "name": 'Quy đổi'           , 'field':"start_debit_vnd"              , "type": 'number_int'         , "sum": True  },
    {"size": 10,  "group": "Dư Có đầu kỳ",    "name": 'Số tiền'           , 'field':"start_credit_usd"             , "type": 'number_float2'      , "sum": True  },
    {"size": 10,  "group": "Dư Có đầu kỳ",    "name": 'Quy đổi'           , 'field':"start_credit_vnd"             , "type": 'number_int'         , "sum": True  },
    {"size": 10,  "group": "Phát sinh Nợ",    "name": 'Số tiền'           , 'field':"ps_debit_usd"                 , "type": 'number_float2'      , "sum": True  },
    {"size": 10,  "group": "Phát sinh Nợ",    "name": 'Quy đổi'           , 'field':"ps_debit_vnd"                 , "type": 'number_int'         , "sum": True  },
    {"size": 10,  "group": "Phát sinh Có",    "name": 'Số tiền'           , 'field':"ps_credit_usd"                , "type": 'number_float2'      , "sum": True  },
    {"size": 10,  "group": "Phát sinh Có",    "name": 'Quy đổi'           , 'field':"ps_credit_vnd"                , "type": 'number_int'         , "sum": True  },
    {"size": 10,  "group": "Dư Nợ cuối kỳ",   "name": 'Số tiền'           , 'field':"end_debit_usd"               , "type": 'number_float2'      , "sum": True  },
    {"size": 10,  "group": "Dư Nợ cuối kỳ",   "name": 'Quy đổi'           , 'field':"end_debit_vnd"               , "type": 'number_int'         , "sum": True  },
    {"size": 10,  "group": "Dư Có cuối kỳ",   "name": 'Số tiền'           , 'field':"end_credit_usd"              , "type": 'number_float2'      , "sum": True  },
    {"size": 10,  "group": "Dư Có cuối kỳ",   "name": 'Quy đổi'           , 'field':"end_credit_vnd"              , "type": 'number_int'         , "sum": True  },
]
...
class tong_hop_cong_no_phai_tra_usd(models.AbstractModel):
    _name = "report.ccv_bao_cao.tong_hop_cong_no_phai_tra_usd"
    _inherit = "report.report_xlsx.abstract"
    _description = TITLE
    
    def _get_data_export(self, obj):
        """Get organized data for export without partner grouping - similar to production report"""
        lines_obj = obj.beta_line4_ids.sudo()
        count = 0
        lines = []
        ...
        for data in lines_obj:
            ...
            vals = {
                ...
                "start_debit_usd": safe_data(data, "start_debit_nt", is_num=True),
                "start_debit_vnd": safe_data(data, "start_debit", is_num=True),
                "start_credit_usd": safe_data(data, "start_credit_nt", is_num=True),
                "start_credit_vnd": safe_data(data, "start_credit", is_num=True),
                "ps_debit_usd": safe_data(data, "ps_debit_nt", is_num=True),
                "ps_debit_vnd": safe_data(data, "ps_debit", is_num=True),
                "ps_credit_usd": safe_data(data, "ps_credit_nt", is_num=True),
                "ps_credit_vnd": safe_data(data, "ps_credit", is_num=True),
                "end_debit_usd": safe_data(data, "end_debit_nt", is_num=True),
                "end_debit_vnd": safe_data(data, "end_debit", is_num=True),
                "end_credit_usd": safe_data(data, "end_credit_nt", is_num=True),
                "end_credit_vnd": safe_data(data, "end_credit", is_num=True),
            }
            lines.append(vals)
    ...
    def add_title(self, sheet, formats, obj):
        ...
        if obj.report_type == 'team' and obj.team_id:
            title_text += f" {obj.team_id.report_name.upper()}"
        ...
        subtitle = '; '.join([
                    ("Tài khoản: %s" % account),
                    ("Loại tiền: USD"),
                    ("Nhà cung cấp: %s" % partner) if partner else "",
    ...
    def add_signatures(self, sheet, formats, obj):
        ...
        if obj.is_sale:
            signature_blocks = [
                ...
                {"role": "Trưởng khu vực", "signer": obj.team_id.user_id.name_without_position if obj.team_id else ""},
