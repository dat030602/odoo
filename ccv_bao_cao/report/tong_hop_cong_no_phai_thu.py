...
COLUMNS = [
    ...
    {"size": 10, "group": "Số dư đầu kỳ", "name": 'Nợ', 'field': "start_debit", "type": 'number_int', "sum": True},
    {"size": 10, "group": "Số dư đầu kỳ", "name": 'Có', 'field': "start_credit", "type": 'number_int', "sum": True},
    {"size": 10, "group": "Số phát sinh", "name": 'Nợ', 'field': "ps_debit", "type": 'number_int', "sum": True},
    {"size": 10, "group": "Số phát sinh", "name": 'Có', 'field': "ps_credit", "type": 'number_int', "sum": True},
    {"size": 10, "group": "Số dư cuối kỳ", "name": 'Nợ', 'field': "end_debit", "type": 'number_int', "sum": True},
    {"size": 10, "group": "Số dư cuối kỳ", "name": 'Có', 'field': "end_credit", "type": 'number_int', "sum": True},
    {"size": 14, "name": 'Mã nhóm khách hàng', 'field': "customer_group", "type": 'text', "sum": False},
]
...
class tong_hop_cong_no_phai_thu(models.AbstractModel):
    ...
    def _get_data_export(self, obj):
        ...
        lines_obj = obj.beta_line1_ids.sudo()
        count = 0
        lines = []
        ...
        for data in lines_obj:
            ...
            vals = {
                ...
                "customer_group": safe_data(data, "customer_group"),
    ...
    def add_title(self, sheet, formats, data):
        ...
        sheet.merge_range("C2:J2","Công ty TNHH Con Cò Vàng - Mã số thuế: 0305995751", formats["company_name"])
