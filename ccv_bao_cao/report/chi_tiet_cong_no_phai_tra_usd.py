...
TITLE = 'Chi tiết công nợ phải trả USD'
...
COLUMNS = [
    ...
    {"size": 10,  "group": "Dư Nợ cuối kỳ",    "name": 'Số tiền'              , 'field':"end_debit_nt"                     , "type": 'number_float2'      , "sum": True  , "value_end": True },
    {"size": 10,  "group": "Dư Nợ cuối kỳ",    "name": 'Quy đổi'              , 'field':"end_debit"                        , "type": 'number_int'         , "sum": True  , "value_end": True },
    {"size": 10,  "group": "Dư Có cuối kỳ",    "name": 'Số tiền'              , 'field':"end_credit_nt"                    , "type": 'number_float2'      , "sum": True  , "value_end": True },
    {"size": 10,  "group": "Dư Có cuối kỳ",    "name": 'Quy đổi'              , 'field':"end_credit"                       , "type": 'number_int'         , "sum": True  , "value_end": True },
    {"size": 5,                                 "name": 'ĐVT'                 , 'field':"uom_id"                           , "type": 'text'               , "sum": False  },
]
...
class chi_tiet_cong_no_phai_tra_usd(models.AbstractModel):
    ...
    def _get_data_export(self, obj):
        ...
        lines_obj = obj.beta_line5_ids.sudo()
            ...
            if line_ids:
                ...
                for data in line_ids:
                    ...
                    vals = {
                        ...
                        "uom_id":                safe_data(data, "uom_id", sub_key="name"),
                    }
                    lines.append(vals)
