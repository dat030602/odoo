...
class HrPayslipEmployees(models.TransientModel):
    ...
    is_ignore_work_entry = fields.Boolean('Ignore work entry', default=True)
    department_ids = fields.Many2many('hr.department', string="Department")
    
    @api.depends('department_id', 'department_ids')
    ...
    def compute_sheet(self):
        if self.is_ignore_work_entry == False:
            ...
            # if self.is_ignore_work_entry == False: #thêm check để ko load vào hr.work.entry
